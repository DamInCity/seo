...
import { CaseStudyLightbox } from '../case-study/CaseStudyLightbox';
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-12 grid lg:grid-cols-2 gap-12 items-center relative z-10">
                <div className="order-2 lg:order-1 relative flex justify-center lg:justify-start">
                    <motion.div style={{ y: mockupY }} className="w-full max-w-xl relative">
                        <img
                            src={project.image}
                            alt={project.name}
                ...
                >
                    <span className="font-mono text-xs mb-4 tracking-widest uppercase opacity-80" style={{ color: project.accent }}>
                        {project.label}
                    </span>
                    <h3 className="text-4xl lg:text-5xl font-bold mb-2 leading-tight" style={{ color: 'var(--text-primary)' }}>
                        {project.name}
                    </h3>
                    ...
                    <button
                        ...
                        className="mt-8 text-sm font-bold uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group text-left"
...
export const SitesGallery = () => {
    ...
    return (
        <>
            ...
            <CaseStudyLightbox project={activeProject} onClose={() => setActiveProject(null)} />
        </>
    );
};