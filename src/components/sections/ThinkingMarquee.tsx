    ...
    return (
        <section id="thinking" className="py-24 bg-bg-main border-y overflow-hidden" style={{ borderColor: 'var(--border-subtle)' }}>
            <div className="relative rotate-[-2deg] scale-110">
                <ParallaxText baseVelocity={-2}>Speed • Structure • Search Intent • Story •</ParallaxText>
                <ParallaxText baseVelocity={2}>Conversion • Authority • Backlinks • Content •</ParallaxText>
            </div>
        </section>
    );
};
